...
#include <ESP8266WiFi.h>          //https://github.com/esp8266/Arduino
  ...
  #define LED_BUILTIN       M5_LED2         // Pin D2 mapped to pin GPIO2/ADC12 of ESP32, control on-board LED
  #define LED_BUILTIN        M5_LED         // Pin D2 mapped to pin GPIO2/ADC12 of ESP32, control on-board LED
  ...
  #define PIN_D15           15        // Pin D15 mapped to pin GPIO15/HSPI_SS/ADC13/TOUCH3/TDO of ESP3                                                                                              2
...
*/
const int TRIGGER_PIN = BUTTON_B_PIN;   // Pin D0 mapped to pin GPIO0/BOOT/ADC11/TOUCH1 of ESP32
/*
...
String  ssid = "SECURE-ADFC" ;
const char* password = "wifiadmin";
...
#warning Using DHCP IP
  ...
  IPAddress gatewayIP   = IPAddress(10, 0, 2, 1);
  ...
  #ifdef ESP32
    IPAddress stationIP   = IPAddress(10, 0, 2, 232);
  #else
    IPAddress stationIP   = IPAddress(10, 9, 2, 186);
  #endif
...
void wm_setup(bool formatsystem)
{
...
if (formatsystem)
  ...
  ESPAsync_wifiManager.setAPStaticIPConfig(IPAddress(10, 0, 2, 1), IPAddress(10, 0, 2, 1), IPAddress(255, 255, 255, 0));
  ...
  if (initialConfig)
  {
    ...
    wifi_setup_screen(ssid, "wifiadmin");
    saveConfigData();
  }
